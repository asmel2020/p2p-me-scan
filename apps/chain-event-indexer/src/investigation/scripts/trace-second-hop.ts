...
async function main() {
  console.log(`=== RASTREANDO SEGUNDO SALTO DE TRANSFERENCIAS ===\n`);
  ...
  const logs = await publicClient.getLogs({
    ...
    args: { from: secondHopWallet },
    fromBlock,
    toBlock: currentBlock,
  });

  console.log(`Total transferencias enviadas desde billetera receptora: ${logs.length}\n`);
